...
public class MyMybatisGenerator extends PluginAdapter {
	...
	// 共通インターフェイス
//	private FullyQualifiedJavaType commonEntitylInterface = new FullyQualifiedJavaType("jp.jast.spbtfw.entity.CommonEntityInterface");
	private FullyQualifiedJavaType commonEntitylInterface = new FullyQualifiedJavaType("jp.co.narikoma.news.common.bean.NewsCommonEntityInterface");
	private FullyQualifiedJavaType commonEntitylClass = new FullyQualifiedJavaType("jp.co.narikoma.news.common.bean.AbstractCommonEntity");
...
//	}
	...
	protected void extModel(TopLevelClass topLevelClass, IntrospectedTable table) {
		...
		topLevelClass.addImportedType(commonEntitylInterface);
		topLevelClass.addSuperInterface(commonEntitylInterface);
